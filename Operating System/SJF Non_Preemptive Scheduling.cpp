...
{ 
    ...
    cout<<endl<<"--SJF NON-PREEMPTIVE SCHEDULING--"<<endl; 
    ...
    for(int i=0; i<num+1; i++)
    {
        ...
        completion_time = completion_time + mat[i][2];
    ...
    for(int i=0;i<num;i++)
    {
        total_waiting_time = total_waiting_time + mat[i][4];
    }
    cout<<"Average Waiting time = "<<total_waiting_time/num<<endl;
}